...
{
    public class When_You_Have_Four_Oranges : IClassFixture<RuleFixture>
    {
        private const int totalOranges = 4;

        private readonly RuleFixture fixture;

        public When_You_Have_Four_Oranges(RuleFixture fixture)
        {
        ...
        {
            this.fixture.Result.Should().Be(0.75m);
        }
