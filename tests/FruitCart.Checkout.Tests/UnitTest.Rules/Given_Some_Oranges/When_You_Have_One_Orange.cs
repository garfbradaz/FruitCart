...
{
    public class When_You_Have_One_Orange : IClassFixture<RuleFixture>
    {
        private const int totalOranges = 1;

        private readonly RuleFixture fixture;

        public When_You_Have_One_Orange(RuleFixture fixture)
        {
        ...
        {
            this.fixture.Result.Should().Be(0.25m);
        }
