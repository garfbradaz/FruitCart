...
{
    public class When_You_Have_Five_Oranges : IClassFixture<RuleFixture>
    {
        private const int totalOranges = 5;

        private readonly RuleFixture fixture;

        public When_You_Have_Five_Oranges(RuleFixture fixture)
        {
        ...
        {
            this.fixture.Result.Should().Be(1.00m);
        }
