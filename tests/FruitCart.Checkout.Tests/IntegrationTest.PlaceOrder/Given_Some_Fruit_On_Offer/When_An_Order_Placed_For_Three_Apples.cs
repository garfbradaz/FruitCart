...
{
    public class When_An_Order_Placed_For_Three_Apples: IClassFixture<IntegrationTestFixture>, IAsyncLifetime
    {
        private readonly IntegrationTestFixture testFixture;

        public When_An_Order_Placed_For_Three_Apples(IntegrationTestFixture testFixture)
        {
        ...
        {
            this.testFixture.Request = new TestPlaceOrderRequestWithThreeApplesOnOffer();
        ...
        {
            this.testFixture.ResponseContent.TotalCostOfOrder.Should().Be(1.20m);
        }
