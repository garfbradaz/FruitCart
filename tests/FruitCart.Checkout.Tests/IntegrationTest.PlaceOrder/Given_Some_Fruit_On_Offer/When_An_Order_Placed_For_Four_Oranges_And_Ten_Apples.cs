...
{
    public class When_An_Order_Placed_For_Four_Oranges_And_Ten_Apples: IClassFixture<IntegrationTestFixture>, IAsyncLifetime
    {
        private readonly IntegrationTestFixture testFixture;

        public When_An_Order_Placed_For_Four_Oranges_And_Ten_Apples(IntegrationTestFixture testFixture)
        {
        ...
        {
            this.testFixture.Request = new TestPlaceOrderRequestWithTenApplesAndFourOrangesOnOffer();
        ...
        {
            this.testFixture.ResponseContent.TotalCostOfOrder.Should().Be(3.75m);
        }
