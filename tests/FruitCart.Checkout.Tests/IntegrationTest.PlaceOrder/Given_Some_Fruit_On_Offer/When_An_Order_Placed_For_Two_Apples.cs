...
{
    public class When_An_Order_Placed_For_Two_Apples: IClassFixture<IntegrationTestFixture>, IAsyncLifetime
    {
        private readonly IntegrationTestFixture testFixture;

        public When_An_Order_Placed_For_Two_Apples(IntegrationTestFixture testFixture)
        {
        ...
        {
            this.testFixture.Request = new TestPlaceOrderRequestWithTwoApplesOnOffer();
        ...
        {
            this.testFixture.ResponseContent.TotalCostOfOrder.Should().Be(0.60m);
        }
