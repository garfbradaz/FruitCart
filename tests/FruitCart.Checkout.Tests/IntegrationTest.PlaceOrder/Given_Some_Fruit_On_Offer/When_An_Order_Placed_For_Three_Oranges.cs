...
{
    public class When_An_Order_Placed_For_Three_Oranges: IClassFixture<IntegrationTestFixture>, IAsyncLifetime
    {
        private readonly IntegrationTestFixture testFixture;

        public When_An_Order_Placed_For_Three_Oranges(IntegrationTestFixture testFixture)
        {
        ...
        {
            this.testFixture.Request = new TestPlaceOrderRequestWithThreeOrangesOnOffer();
        ...
        {
            this.testFixture.ResponseContent.TotalCostOfOrder.Should().Be(0.5m);
        }
